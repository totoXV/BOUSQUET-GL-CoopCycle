...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../livreur.test-samples';

import { LivreurService } from './livreur.service';

const requireRestSample: ILivreur = {
...
describe('Livreur Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Livreur', () => {
      ...
      const livreur = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(livreur).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Livreur', () => {
      const livreur = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(livreur).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addLivreurToCollectionIfMissing', () => {
      it('should add a Livreur to an empty array', () => {
        const livreur: ILivreur = sampleWithRequiredData;
      ...
      it("should add a Livreur to an array that doesn't contain it", () => {
        const livreur: ILivreur = sampleWithRequiredData;
        const livreurCollection: ILivreur[] = [sampleWithPartialData];
        expectedResult = service.addLivreurToCollectionIfMissing(livreurCollection, livreur);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(livreur);
      });
      ...
      it('should add only unique Livreur to an array', () => {
        const livreurArray: ILivreur[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const livreurCollection: ILivreur[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const livreur: ILivreur = sampleWithRequiredData;
        const livreur2: ILivreur = sampleWithPartialData;
    ...
    describe('compareLivreur', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareLivreur(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareLivreur(entity1, entity2);
        const compareResult2 = service.compareLivreur(entity2, entity1);
